...
- **Dashboard** — Clean landing screen after login with a floating action button (FAB) menu that expands to reveal quick actions:
  - **Add food or drink** — opens a quick-add modal
  - **Log a symptom** — opens a symptom form modal
